...
void MainWindow::Render()
{
    ...
    trans = glm::rotate(trans, static_cast<float>(glfwGetTime()), glm::vec3(0.0f, 0.0f, 1.0f)); // 绕Z轴根据时间旋转
    trans = glm::scale(trans, glm::vec3(0.5f, 0.5f, 0.5f)); // 缩放到原来的一半
    shaderPrograms_[0].SetUniformMat4f("trans", glm::value_ptr(trans));

...
void MainWindow::Render()
{
    ...
    shaderPrograms_[0].SetUniform1i("grassSampler", 0);
    shaderPrograms_[0].SetUniform1i("landSampler", 1);
    shaderPrograms_[0].SetUniform1i("noiseSampler", 2);
...
void MainWindow::PrepareTexture()
{
    ...
    texture3_.LoadFromFile("assets/image/noise.jpeg", 2);
}
